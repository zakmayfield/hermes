...
export const InvoiceManager = () => {
  return (
    <div className="bg-theme-primary rounded-lg p-lg">
      <h2 className="mb-lg">Invoice Manager</h2>

      <div className="bg-theme-secondary rounded-lg p-lg">
        ...
        <div className="bg-theme-primary rounded-lg p-md">
          ...
          {dummyOrders.map((order) => (
            <div
              ...
              className="flex items-center gap-lg p-xs bg-theme-tertiary/25 rounded-lg mt-md"
            >
